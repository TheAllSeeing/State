...
class MonthResultsAdapter:
    ...
    def get_display_results(self, statement: MonthlyStatement) -> DisplayMonthResults:
        return DisplayMonthResults(
